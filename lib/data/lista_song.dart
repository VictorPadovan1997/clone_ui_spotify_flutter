...
List<Song> recents = [
  ...
  Song(
    coverImage:
        'https://www.pngkit.com/png/full/417-4173000_album-cover-collage-chris-brown-f-a-m-e-deluxe-version.png',
...
List<Song> madefor = [
  ...
  Song(
    coverImage: 'https://miro.medium.com/max/600/1*94MOjMwe6v6udVuWYiDqyQ.png',
    caption: 'Tea Kadai talks',
  ),
  Song(
    coverImage:
...
List<Song> unique = [
  Song(
    coverImage: 'https://i.ibb.co/3FLDDdH/Design-sem-nome.png',
    caption: 'HillSongs Favourite',
  ),
  Song(
    coverImage:
...
List<Song> bestof = [
  ...
  Song(
    coverImage: 'https://pbs.twimg.com/media/D8lclKYXsAIO-W9.png',
    caption: 'Evergreen Tamil hits',
  ),
  Song(
    coverImage:
